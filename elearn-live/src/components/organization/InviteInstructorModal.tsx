...
import { X, Mail, AlertCircle, CheckCircle, User } from "lucide-react";
...
export const InviteInstructorModal = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setLoading(true);
      await onInvite({ name: formData.name, email: formData.email });
      setSuccess(true);
      setTimeout(() => {
        setFormData({ name: "", email: "" });
        setError("");
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-xl font-bold text-gray-900">Add Instructor</h2>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {success && (
            ...
            >
              ...
              <p className="text-green-800 text-sm">Instructor added successfully!</p>
            </motion.div>
          )}
          ...
          <div>
            ...
            <p className="mt-2 text-xs text-gray-500">
              Share these credentials with the instructor to sign in.
            </p>
          </div>
