            ...
            >
              ...
              <div className="bg-white rounded-xl p-6 border-2 border-gray-200 shadow-sm">
                ...
                <div className="text-center mb-6">
                  ...
                  <p className="text-sm text-gray-600 mb-3">{userData.profession}</p>
                  ...
                  <div className="flex items-center justify-between mb-6">
                    ...
                    {!isEditing ? (
                      ...
                      <div className="flex gap-2">
                        ...
                        <button 
                          onClick={() => setIsEditing(false)}
                          className="px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-700 rounded-lg font-semibold flex items-center gap-2 transition-colors"
                        >
                          <X size={16} />
                          Cancel
                        </button>
                  ...
                  <div className="space-y-5">
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            value={userData.name}
                            disabled={!isEditing}
                            className="w-full pl-10 pr-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-blue-600 text-gray-900 disabled:bg-gray-50 disabled:text-gray-600"
                          />
                        </div>
                      </div>
                      <div>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        disabled={!isEditing}
                        rows={4}
                        className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-blue-600 text-gray-900 disabled:bg-gray-50 disabled:text-gray-600"
                      />
                    </div>
                      ...
                      <div className="grid sm:grid-cols-3 gap-3">
                        <div className="relative">
                          ...
                          <input
                            ...
                            disabled={!isEditing}
                            className="w-full pl-10 pr-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-blue-600 text-gray-900 disabled:bg-gray-50"
                          />
                        </div>
                        <div className="relative">
                ...
                >
                  ...
                  <div className="bg-white rounded-xl p-6 border-2 border-gray-200 shadow-sm">
                    ...
                    <div className="space-y-4">
                      ...
                      <button className="w-full sm:w-auto px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-semibold transition-colors">
                        Update Password
                      </button>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-xl p-6 border-2 border-gray-200 shadow-sm">
                    <div className="flex items-start justify-between">
                      ...
                      <button className="px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg font-semibold text-sm transition-colors flex-shrink-0 ml-4">
                        Enable 2FA
                      </button>
                    </div>
                  </div>
                ...
                >
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      <div key={index} className="flex items-center justify-between p-4 border-2 border-gray-200 rounded-lg hover:border-blue-600 transition-colors">
                        <div className="flex-1">
                ...
                >
                  ...
                  <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {enrolledCourses.map((course) => (
                      <div key={course.id} className="p-4 border-2 border-gray-200 rounded-lg hover:border-blue-600 hover:shadow-md transition-all cursor-pointer">
                        <img 
                        ...
                        <div className="space-y-2">
                          ...
                          <p className="text-xs text-gray-600 font-semibold">{course.progress}% complete</p>
                        </div>
                      </div>
                    ))}
                  </div>
